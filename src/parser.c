...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr_op, 1),
  [115] = {.entry = {.count = 1, .reusable = false}}, SHIFT(501),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expr_op, 1),
  ...
  [278] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_expression_repeat1, 2), SHIFT_REPEAT(8),
